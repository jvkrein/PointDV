  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <TouchableOpacity style={[styles.typeSelector, userType === 'lojista' && styles.typeSelectorActive]} onPress={() => setUserType('lojista')}>
        ...
        {userType === 'lojista' && (
          <>
            ...
            <View style={styles.inputContainer}><MaterialCommunityIcons name="storefront-outline" size={20} color={COLORS.gray} style={styles.inputIcon} /><TextInput placeholder="Nome do seu negócio" style={styles.input} placeholderTextColor={COLORS.gray} /></View>
            <View style={styles.inputContainer}><MaterialCommunityIcons name="phone-outline" size={20} color={COLORS.gray} style={styles.inputIcon} /><TextInput placeholder="(11) 99999-9999" style={styles.input} keyboardType="phone-pad" placeholderTextColor={COLORS.gray} /></View>
            <View style={styles.inputContainer}><MaterialCommunityIcons name="map-marker-outline" size={20} color={COLORS.gray} style={styles.inputIcon} /><TextInput placeholder="Endereço completo do estabelecimento" style={styles.input} placeholderTextColor={COLORS.gray} /></View>
          </>
        )}
