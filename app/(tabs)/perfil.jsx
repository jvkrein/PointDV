// app/(tabs)/perfil.jsx (VERSÃO FINAL COM BOTÕES FUNCIONAIS)

import { MaterialCommunityIcons } from '@expo/vector-icons';
import { router } from 'expo-router';
import { StatusBar } from 'expo-status-bar';
import { useContext } from 'react'; // Adicionado React para clareza
import { ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native'; // Adicionado Alert
...
const ProfileListItem = ({ icon, title, subtitle, onPress }) => (
  <TouchableOpacity style={styles.listItem} onPress={onPress}>
    <View style={styles.listItemIcon}><MaterialCommunityIcons name={icon} size={24} color={COLORS.primary} /></View>
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView>
        <View style={styles.header}>
          ...
          <View style={styles.avatar}><MaterialCommunityIcons name="account-outline" size={40} color={COLORS.primary} /></View>
        ...
        <View style={styles.content}>
          <View style={styles.infoCard}>
            ...
            {userType === 'lojista' && (
              <><View style={styles.divider} /><View style={styles.infoItem}><MaterialCommunityIcons name="storefront-outline" size={24} color={COLORS.primary} /><View style={styles.infoTextContainer}><Text style={styles.infoTitle}>Estabelecimento</Text><Text style={styles.infoValue}>{userData.establishment}</Text></View></View></>
            )}
          </View>
          ...
          <View style={styles.actionList}>
            {userType === 'lojista' && (
              // O botão "Gerenciar Eventos" agora leva para a aba "Meus Eventos"
              <ProfileListItem 
                icon="calendar-edit" 
            ...
            {/* O botão "Meus Eventos" agora leva para a aba "Meus Eventos" */}
            <ProfileListItem 
              ...
              onPress={() => router.push('/(tabs)/meus-eventos')}
            />
            {/* O botão "Favoritos" agora leva para a aba "Favoritos" */}
            <ProfileListItem 
              icon="heart-outline" 
              title="Favoritos" 
            ...
            />
            {/* O botão "Configurações" agora leva para a aba "Configurações" */}
            <ProfileListItem 
            icon="cog-outline" 
            title="Configurações" 
          ...
          <View style={styles.aboutSection}>
            ...
            <View style={{flex: 1, marginLeft: 15}}>
              ...
              <Text style={styles.aboutText}>Descubra eventos e promoções locais. Conecte-se com os melhores estabelecimentos da sua cidade.</Text>
